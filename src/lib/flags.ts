// ISO 3166-1 alpha-2 country codes with emoji flags
// Used in the Flags panel in the editor sidebar
...
export const FLAGS: FlagItem[] = [
  ...
  { code: "UN", name: "United Nations", emoji: "🇺🇳" },
];

/** Popular flags shown first in the panel */
export const POPULAR_FLAGS = ["US", "GB", "DE", "FR", "ES", "IT", "BR", "JP", "CN", "IN", "AU", "CA", "KR", "RO", "UA", "RU", "TR", "MX", "ID", "SA"];

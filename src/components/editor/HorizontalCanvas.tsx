      ...
      <div className="min-w-fit px-12 py-10 space-y-12">
        {screenSets.map((ss) => (
          <div key={ss.id} className="space-y-3">
            ...
            {/* Reference Existing App row */}
            <ReferenceAppRow screenSet={ss} />
          </div>
        ))}
        ...
        <div className="flex items-center gap-3 pt-4 pb-8">
          {!hasIOS && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-blue-500/30 bg-blue-500/8 text-blue-400 hover:bg-blue-500/15 text-sm font-medium transition-all"
            >
          ...
          {!hasAndroid && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-green-500/30 bg-green-500/8 text-green-400 hover:bg-green-500/15 text-sm font-medium transition-all"
            >
              <Plus className="w-4 h-4" />
              Add Android Set
            </button>
